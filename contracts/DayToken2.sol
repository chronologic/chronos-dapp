 ...
 */
contract DayToken2 is  ReleasableToken, MintableToken, UpgradeableToken {
    ...
    /**
        ...
        */
    function DayToken2(string _name, string _symbol, uint _maxAddresses, uint _firstTeamContributorId, uint _totalTeamContributorIds, 
