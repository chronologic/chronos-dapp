...
export function showNoMetaMaskAlert() {
  var content = ReactDOM.render(<b>You need <a href="https://metamask.io/">MetaMask</a> browser plugin to run this
...
export function showNoMetaMaskAccountsAlert() {
  var content = ReactDOM.render(<b>Metamask has no Accounts or is Locked. Kindly create and unlock you account to proceed.</b>,sweetAlertContainer);
  return sweetAlert({
    title: 'No Accounts',
    content: content,
    icon: 'warning'
