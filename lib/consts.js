...
export const PROPERTIES = [
  ...
  {
    name: 'interestCycle',
    title: 'Interest Cycle in Periods',
    description: 'Length of each Interest cycle (periods)',
  ...
  {
    name: 'loanTerm',
    title: 'Loan Maturity Term in Periods',
    description: 'Number of periods for Loan Maturity (periods)',
...
export const DEBT_CONTRACT_LABELS = {
  ...
  interestCycle: 'Interest Cycle in Periods',
  interestRate: 'Interest rate per cycle',
  loanTerm: 'Loan Term in Periods',
