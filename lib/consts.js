export const NAVIGATION_STEPS = {
  ...
  debt:{
      DEBT_TOKEN_SETUP: {
        ...
        iconClassName: 'step-icons_debt-token-setup',
        propertyKeys: ['tokenName', 'symbol'],
        nextUrl: '/debt/step-2',
      },
      INTEREST_RATES_SETUP: {
        ...
        iconClassName: 'step-icons_interest-rate-setup',
      ...
      LENDER_SETUP: {
        ...
        iconClassName: 'step-icons_lender-setup',
      ...
      DEBT_PUBLISH: {
        ...
        iconClassName: 'step-icons_debt-publish',
      ...
      DEBT_WATCH: {
        ...
        iconClassName: 'step-icons_debt-watch',
        propertyKeys: ['receiverAddress','tokens','weiAmount','timemintId','teamMember','isTest'],
        prevUrl: '/debt/step-4',
      }
  }
...
export const PROPERTIES = [
  ...
  },
  {
    name: 'decimalUnits',
    title: 'Decimal Units',
    description: 'Decimal units for the Debt tokens',
    errorMessage: 'Please enter a Decimal Units ',
    validator: value => new RegExp('^\\d+$').test(value) && value.length > 0 && Number(value) > 0 && value.length < 30,
  },
];
