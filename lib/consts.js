export const NAVIGATION_STEPS = {
  daytoken:{
      ...
      PUBLISH: {
        ...
        propertyKeys: ['tokenName', 'symbol',
          ...
          'teamLockPeriod', 'postDeploymentMaxIds', 'minimumBalance'],
        nextUrl: '/daytoken/step-5',
        prevUrl: '/daytoken/step-3',
      },
      WATCH: {
        idx: 5,
        title: 'Watch Page',
  ...
  debt:{
      ...
      INTEREST_RATES_SETUP: {
        ...
        propertyKeys: ['interestRate','interestCycle','loanTerm'],
        nextUrl: '/debt/step-3',
      },
      LENDER_SETUP: {
        idx: 3,
      ...
      DEBT_PUBLISH: {
        ...
        'loanTerm','dayLength','debtOwner','initialAmount','exchangeRate'],
        nextUrl: '/debt/step-5',
        prevUrl: '/debt/step-3',
      },
      DEBT_WATCH: {
        idx: 5,
        title: 'Watch Page',
        description: 'Watch your deployed debt contract details and also update Interest, fund and refund',
...
export const PROPERTIES = [
  ...
  {
    name: 'interestCycle',
    title: 'Interest Cycle in Seconds',
    description: 'Length of each Interest cycle (secs)',
  ...
  {
    name: 'loanTerm',
    title: 'Loan Maturity Term in Seconds',
    description: 'Number of seconds for Loan Maturity (secs)',
    errorMessage: 'Please enter a valid Loan Maturity Length ',
    validator: value => new RegExp('^\\d+$').test(value) && value.length > 0 && Number(value) > 0 && value.length < 30,
  },
  {
    name: 'dayLength',
    title: 'Period Length in Seconds',
    description: 'Number of seconds in a Period (secs)',
...
export const NETWORK_MESSAGES = {
  '1': 'You are connected to Mainnet. This is NOT a DRILL!!!',
...
export const DEBT_CONTRACT_LABELS = {
  address: 'contract address',
  tokenName: 'debt token name',
  symbol: 'debt token symbol',
  totalSupply:'Total Supply',
  exchangeRate: 'debt token exchange rate',
  isTermOver: 'Has Interest begun Accruing',
  dayLength: 'Period Length in Seconds',
  interestCycle: 'Interest Cycle in Seconds',
  interestRate: 'Interest rate per cycle',
  loanTerm: 'Loan Term in Seconds',
  initialLoanAmount: 'Initial Loan Value',
  loanAmount: 'Present Loan Value',
  loanActivation: 'Loan commenced',
  totalInterestCycle: 'Total Interest Cycle',
  lastInterstCycle: 'Last Interest Cycle',
  borrower: 'Borrower Address',
  lender: 'Lender Address',
  isLoanFunded: 'Is Loan Funded'
}
