...
export const PROPERTIES = [
  ...
  {
    name: 'interestCycle',
    title: 'Periods per Interest Cycle',
    description: 'Length of each Interest cycle (period)',
  ...
  },
  {
    ...
    description: 'Number of days for Loan Maturity (period)',
...
export const DEBT_CONTRACT_LABELS = {
  ...
  interestCycle: 'Periods per Interest Cycle',
  interestRate: 'Interest rate per cycle',
  loanTerm: 'Loan Term in Period',
