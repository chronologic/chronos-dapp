...
export const PROPERTIES = [
  ...
  },
  {
    ...
    description: 'Length of each Interest cycle (days)',
...
export const DEBT_CONTRACT_LABELS = {
  ...
  isTermOver: 'has loan been fulfilled and closed',
  dayLength: 'Day Length in Seconds',
  interestCycle: 'Interest Cycle in Days',
  interestRate: 'Interest rate per cycle',
  loanTerm: 'Loan Term in Days',
  initialLoanAmount: 'Initial Loan Value',
  loanAmount: 'Present Loan Value',
  loanActivation: 'when loan commenced',
