export const NAVIGATION_STEPS = {
  ...
  WATCH: {
    ...
    propertyKeys: ['receiverAddress','tokens','weiAmount','timemintId'],
    prevUrl: '/step-4',
  },
};
...
export const PROPERTIES = [
  ...
  {
    name: 'tokens',
    title: 'Timemint Tokens',
    description: 'Number of TimeMint tokens to be awarded ',
  ...
  },
  {
    ...
    errorMessage: 'Please enter a valid WEI Value',
    validator: value => new RegExp('^\\d+$').test(value) && value.length > 0 && value.length < 30,
  },
  {
    name: 'timemintId',
