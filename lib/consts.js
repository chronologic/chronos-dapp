export const NAVIGATION_STEPS = {
  TOKEN_SETUP: {
    idx: 1,
    title: 'Token Setup',
    description: 'Select the futures for your own version of the DAY token ( WEI )',
  ...
  TIMEMINT_SETUP: {
    ...
    description: 'Setup minting and halving rate your contract will apply ( WEI )',
  ...
  CONTRACT_SETUP: {
    ...
    description: 'Choose the specifics of your smart contract ( WEI )',
  ...
  PUBLISH: {
    idx: 4,
    title: 'Publish',
    description: 'Check your contract\'s data and proceed with the deployment ( WEI )',
  ...
  WATCH: {
    idx: 5,
    title: 'Watch Page',
    description: 'Watch your deployed contract details and also assign late TimeMints ( WEI )',
